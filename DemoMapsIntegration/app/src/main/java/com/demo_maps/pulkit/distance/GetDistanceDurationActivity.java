...
public class GetDistanceDurationActivity extends AppCompatActivity implements View.OnClickListener
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_your_places) {
            ...
            /*------------------Simple with method-----------------------*/
            /*calculateDistanceThroughMethod();*/
    ...
    /*Calculate Distance Start to End and Durtaion as well through distanceBetween() method */
    private void calculateDistanceThroughMethod() {
    ...
    /*Calculate Distance Start to End and Durtaion as well through API */
...
//        mMap.clear();
    ...
    private String getDirectionUrl() {
        ...
        /*Distance and Duration API*/

        StringBuilder googleDirectionsUrl = new StringBuilder("https://maps.googleapis.com/maps/api/directions/json?");
        googleDirectionsUrl.append("origin=" + latitude + "," + longitude);
        googleDirectionsUrl.append("&destination=" + end_latitude + "," + end_longitude);
        googleDirectionsUrl.append("&key=AIzaSyDmwKX_hspvHd8nnVGTlTDRHRKqKiMFts4");
